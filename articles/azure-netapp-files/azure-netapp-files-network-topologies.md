...
* The number of IPs in use in a VNet with Azure NetApp Files (including directly peered VNets) cannot exceed 1000. We are working towards increasing this limit to meet customer scale demands. In the interim, if you require for more IPs, reach out to our support team with your use case and required limit.
